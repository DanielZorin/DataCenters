...
//    n.addLink(l13);
    ...
    Node * vm2 = new Node("vm2", 1);
    Node * vm3 = new Node("vm3", 2);
    Node * vm4 = new Node("vm4", 2);
    vm1->setRamCapacity(1);
    vm2->setRamCapacity(1);
    vm3->setRamCapacity(5);
    vm4->setRamCapacity(1);
    Store * st1 = new Store("st1", 1);
    Store * st2 = new Store("st2", 1);
    Store * st3 = new Store("st3", 2);
//    Store * st5 = new Store("", 2);
//    Store * st6 = new Store("", 2);
//    Store * st7 = new Store("", 2);
    Store * st4 = new Store("st4", 2, 2, 1);
//    Store * st5 = new Store("", 20);
    Link * ch1 = new Link("vm1st1", 3);
    Link * ch2 = new Link("st2vm1", 3);
    Link * ch3 = new Link("vm2st1", 3);
    Link * ch4 = new Link("vm2st2", 3);
    Link * ch5 = new Link("vm3st3", 5);
    Link * ch6 = new Link("vm3st4", 5);
    Link * ch7 = new Link("vm4st3", 5);
    Link * ch8 = new Link("st4vm4", 5);
//    Link * ch9 = new Link("", 500);
    ch1->bindElements(vm1, st1);
    ch2->bindElements(st2, vm1);
    ch3->bindElements(vm2, st1);
    ch4->bindElements(vm2, st2);
    ch5->bindElements(vm3, st3);
    ch6->bindElements(vm3, st4);
    ch7->bindElements(vm4, st3);
    ch8->bindElements(st4, vm4);

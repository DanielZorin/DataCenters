...
inline double MoreResourceFirst::calculate(unsigned int param1, unsigned int param2, unsigned int param3)
{
...
inline double LargeRequestFirst::calculate(unsigned int param1, unsigned int param2, unsigned int param3)
{

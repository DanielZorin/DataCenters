...
"}"))
        ...
        self.actionComputer = QtGui.QAction(GraphEditor)
        ...
        self.actionStorage = QtGui.QAction(GraphEditor)
        ...
        self.actionRouter = QtGui.QAction(GraphEditor)
        ...
        QtCore.QObject.connect(self.actionComputer, QtCore.SIGNAL(_fromUtf8("triggered()")), GraphEditor.toggleComputer)
        ...
        QtCore.QObject.connect(self.actionStorage, QtCore.SIGNAL(_fromUtf8("triggered()")), GraphEditor.toggleStorage)
        QtCore.QObject.connect(self.actionRouter, QtCore.SIGNAL(_fromUtf8("triggered()")), GraphEditor.toggleRouter)
        QtCore.QMetaObject.connectSlotsByName(GraphEditor)

    def retranslateUi(self, GraphEditor):
        GraphEditor.setWindowTitle(QtGui.QApplication.translate("GraphEditor", "Resources Graph Editor", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionComputer.setText(QtGui.QApplication.translate("GraphEditor", "Add Computer", None, QtGui.QApplication.UnicodeUTF8))
        self.actionComputer.setToolTip(QtGui.QApplication.translate("GraphEditor", "Add Computer", None, QtGui.QApplication.UnicodeUTF8))
        self.actionComputer.setShortcut(QtGui.QApplication.translate("GraphEditor", "Alt+2", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionNew_System.setText(QtGui.QApplication.translate("GraphEditor", "New Graph", None, QtGui.QApplication.UnicodeUTF8))
        self.actionNew_System.setShortcut(QtGui.QApplication.translate("GraphEditor", "Ctrl+N", None, QtGui.QApplication.UnicodeUTF8))
        self.actionOpen_System.setText(QtGui.QApplication.translate("GraphEditor", "Open Graph", None, QtGui.QApplication.UnicodeUTF8))
        self.actionOpen_System.setShortcut(QtGui.QApplication.translate("GraphEditor", "Ctrl+O", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSave_System.setText(QtGui.QApplication.translate("GraphEditor", "Save Graph", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSave_System.setShortcut(QtGui.QApplication.translate("GraphEditor", "Ctrl+S", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSave_System_As.setText(QtGui.QApplication.translate("GraphEditor", "Save Graph As...", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionStorage.setText(QtGui.QApplication.translate("GraphEditor", "Add Storage", None, QtGui.QApplication.UnicodeUTF8))
        self.actionStorage.setToolTip(QtGui.QApplication.translate("GraphEditor", "Add Storage", None, QtGui.QApplication.UnicodeUTF8))
        self.actionStorage.setShortcut(QtGui.QApplication.translate("GraphEditor", "Alt+4", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRouter.setText(QtGui.QApplication.translate("GraphEditor", "Add Router", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRouter.setToolTip(QtGui.QApplication.translate("GraphEditor", "Add Router", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRouter.setShortcut(QtGui.QApplication.translate("GraphEditor", "Alt+5", None, QtGui.QApplication.UnicodeUTF8))

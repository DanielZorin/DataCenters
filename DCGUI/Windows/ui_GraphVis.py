...
"}"))
    ...
    def retranslateUi(self, GraphVis):
        ...
        self.scaledown.setText(QtGui.QApplication.translate("GraphVis", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.scaleup.setText(QtGui.QApplication.translate("GraphVis", "+", None, QtGui.QApplication.UnicodeUTF8))

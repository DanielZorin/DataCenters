...
"}a"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.demands.headerItem().setText(1, _translate("MainWindow", "Starting time", None))
        self.demands.headerItem().setText(2, _translate("MainWindow", "End time", None))
        self.demands.headerItem().setText(3, _translate("MainWindow", "Allow rescheduling", None))
        self.demands.headerItem().setText(4, _translate("MainWindow", "Scheduled", None))
        ...
        self.demandcount.setText(_translate("MainWindow", "0", None))
        self.label.setText(_translate("MainWindow", "Average computational nodes CPU load", None))
        self.vmavg.setText(_translate("MainWindow", "0", None))
        self.label_3.setText(_translate("MainWindow", "Maximal computational nodes CPU load", None))
        self.vmmax.setText(_translate("MainWindow", "0", None))
        self.label_8.setText(_translate("MainWindow", "Average computational nodes RAM load", None))
        self.ramavg.setText(_translate("MainWindow", "0", None))
        self.label_10.setText(_translate("MainWindow", "Maximal computational nodes RAM load", None))
        self.rammax.setText(_translate("MainWindow", "0", None))
        self.label_6.setText(_translate("MainWindow", "Average stores load", None))
        self.stavg.setText(_translate("MainWindow", "0", None))
        self.label_7.setText(_translate("MainWindow", "Maximal stores load", None))
        self.stmax.setText(_translate("MainWindow", "0", None))
        self.label_9.setText(_translate("MainWindow", "Average network load", None))
        self.netavg.setText(_translate("MainWindow", "0", None))
        self.label_11.setText(_translate("MainWindow", "Maximal network load", None))
        self.netmax.setText(_translate("MainWindow", "0", None))
        self.label_4.setText(_translate("MainWindow", "Average leaf channels load", None))
        self.leafavg.setText(_translate("MainWindow", "0", None))
        self.label_5.setText(_translate("MainWindow", "Maximal leaf channels load", None))
        self.leafmax.setText(_translate("MainWindow", "0", None))
        ...
        self.actionAdd_Demand.setText(_translate("MainWindow", "Add Request", None))
        ...
        self.actionDelete_Demand.setText(_translate("MainWindow", "Delete Request", None))
        self.actionDelete_Demand.setToolTip(_translate("MainWindow", "Delete Request", None))
        ...
        self.actionEdit_Demand.setText(_translate("MainWindow", "Edit Request", None))
        self.actionEdit_Demand.setToolTip(_translate("MainWindow", "Edit Request", None))
        ...
        self.actionSchedule_selected.setText(_translate("MainWindow", "Schedule selected", None))

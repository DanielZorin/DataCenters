...
"}a"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.algorithm.setItemText(0, _translate("MainWindow", "Simulated Annealing", None))
        self.algorithm.setItemText(1, _translate("MainWindow", "Ant Colony", None))
        self.algorithm.setItemText(2, _translate("MainWindow", "Centralized", None))
        self.algorithm.setItemText(3, _translate("MainWindow", "Decentralized", None))
        self.algorithm.setItemText(4, _translate("MainWindow", "FirstFit", None))
        self.algorithm.setItemText(5, _translate("MainWindow", "RandomFit", None))

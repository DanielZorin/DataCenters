...
"}"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tenants.headerItem().setText(1, _translate("MainWindow", "Starting time", None))
        self.tenants.headerItem().setText(2, _translate("MainWindow", "End time", None))
        self.tenants.headerItem().setText(3, _translate("MainWindow", "Allow rescheduling", None))
        self.tenants.headerItem().setText(4, _translate("MainWindow", "Scheduled", None))

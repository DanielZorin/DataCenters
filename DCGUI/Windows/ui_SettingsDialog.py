...
"}a"))
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_5.setText(_translate("SettingsDialog", "Axis Color", None))
        self.label_6.setText(_translate("SettingsDialog", "Graph Color", None))
        self.net.setText(_translate("SettingsDialog", "Show Net", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("SettingsDialog", "Graph Plotter", None))

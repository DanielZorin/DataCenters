...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/pics/pics/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SettingsDialog.setWindowIcon(icon)
        SettingsDialog.setStyleSheet("QWidget, QMenuBar::item {\n"
...
"}a")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/pics/pics/line_chart.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/pics/pics/chart.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL("clicked()"), SettingsDialog.OK)
        QtCore.QObject.connect(self.selection, QtCore.SIGNAL("clicked()"), SettingsDialog.SelectionColor)
        QtCore.QObject.connect(self.pushButton_2, QtCore.SIGNAL("clicked()"), SettingsDialog.Cancel)
        QtCore.QObject.connect(self.highlight, QtCore.SIGNAL("clicked()"), SettingsDialog.HighlightColor)
        QtCore.QObject.connect(self.axis, QtCore.SIGNAL("clicked()"), SettingsDialog.AxisColor)
        QtCore.QObject.connect(self.graph, QtCore.SIGNAL("clicked()"), SettingsDialog.GraphColor)

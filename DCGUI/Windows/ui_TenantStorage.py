...
""))
        ...
        self.timelabel = QtGui.QLabel(TenantStorage)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.created = QtGui.QLineEdit(TenantStorage)
    ...
    def retranslateUi(self, TenantStorage):
        ...
        self.timelabel.setText(_translate("TenantStorage", "Created:", None))
        self.label.setText(_translate("TenantStorage", "Updated:", None))
        self.label_2.setText(_translate("TenantStorage", "Deleted:", None))
        self.delbox.setText(_translate("TenantStorage", "Deleted", None))

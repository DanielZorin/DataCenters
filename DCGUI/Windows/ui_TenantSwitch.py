...
"}"))
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.serviceasuser)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.provider)
        ...
        self.prefix = QtGui.QLineEdit(TenantSwitch)
        self.prefix.setObjectName(_fromUtf8("prefix"))
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.prefix)
    ...
    def retranslateUi(self, TenantSwitch):
        ...
        self.label.setText(_translate("TenantSwitch", "Prefix:", None))

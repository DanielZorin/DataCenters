...
"}"))
        ...
        self.timelabel = QtGui.QLabel(TenantSwitch)
        ...
        self.created = QtGui.QLineEdit(TenantSwitch)
        ...
        self.label = QtGui.QLabel(TenantSwitch)
        self.label.setObjectName(_fromUtf8("label"))
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.label)
        self.updated = QtGui.QLineEdit(TenantSwitch)
        ...
        self.formLayout.setWidget(7, QtGui.QFormLayout.LabelRole, self.router)
        self.ip = QtGui.QLineEdit(TenantSwitch)
        self.ip.setObjectName(_fromUtf8("ip"))
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.ip)
    ...
    def retranslateUi(self, TenantSwitch):
        ...
        self.timelabel.setText(_translate("TenantSwitch", "Created:", None))
        self.namelabel.setText(_translate("TenantSwitch", "Name:", None))
        self.label.setText(_translate("TenantSwitch", "Updated:", None))
        self.label_2.setText(_translate("TenantSwitch", "Deleted:", None))
        self.delbox.setText(_translate("TenantSwitch", "Deleted", None))

...
"}"))
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.LabelRole, self.router)
        self.ip = QtGui.QLineEdit(TenantSwitch)
        self.ip.setObjectName(_fromUtf8("ip"))
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.ip)
        self.serviceasuser = QtGui.QCheckBox(TenantSwitch)
        self.serviceasuser.setObjectName(_fromUtf8("serviceasuser"))
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.serviceasuser)
        self.port = QtGui.QComboBox(TenantSwitch)
        self.port.setObjectName(_fromUtf8("port"))
        self.formLayout.setWidget(9, QtGui.QFormLayout.FieldRole, self.port)
        ...
        self.formLayout.setWidget(8, QtGui.QFormLayout.FieldRole, self.provider)

...
"}"))
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.LabelRole, self.router)
        self.ip = QtGui.QLineEdit(TenantSwitch)
        self.ip.setObjectName(_fromUtf8("ip"))
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.ip)

...
"}"))
        ...
        self.timelabel = QtGui.QLabel(TenantVM)
        ...
        self.created = QtGui.QLineEdit(TenantVM)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.image)
    ...
    def retranslateUi(self, TenantVM):
        ...
        self.timelabel.setText(_translate("TenantVM", "Created:", None))
        self.namelabel.setText(_translate("TenantVM", "Name:", None))
        self.label.setText(_translate("TenantVM", "Updated:", None))
        self.label_2.setText(_translate("TenantVM", "Deleted:", None))
        self.delbox.setText(_translate("TenantVM", "Deleted", None))

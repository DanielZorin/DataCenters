...
"}"))
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.profile)
        self.servicename = QtGui.QLineEdit(TenantVnf)
        self.servicename.setObjectName(_fromUtf8("servicename"))
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.servicename)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.set)
        ...
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.username)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.serviceasprovider)

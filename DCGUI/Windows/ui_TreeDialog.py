...
class Ui_TreeDialog(object):
    def setupUi(self, TreeDialog):
        ...
        TreeDialog.setStyleSheet("QWidget, QMenuBar::item, QHeaderView::section {\n"
...
"}")
        ...
        self.routersNum0.setObjectName("routersNum0")
        ...
        self.rootLevel.setObjectName("rootLevel")
        ...
        self.routerBandwidth0.setObjectName("routerBandwidth0")
        ...
        self.routerChilds0.setObjectName("routerChilds0")
        ...
        self.channelsBandwidth0.setObjectName("channelsBandwidth0")
        ...
        self.numRouters1Lab.setObjectName("numRouters1Lab")
        ...
        self.routersNum1.setObjectName("routersNum1")
        ...
        self.routerBandwidth1.setObjectName("routerBandwidth1")
        ...
        self.routerChilds1.setObjectName("routerChilds1")
        ...
        self.channelsBandwidth1.setObjectName("channelsBandwidth1")
        ...
        self.routerBandwidth2.setObjectName("routerBandwidth2")
        ...
        self.computersNodes.setObjectName("computersNodes")
        ...
        self.storagesNodes.setObjectName("storagesNodes")
        ...
        self.storagesNum.setObjectName("storagesNum")
        ...
        self.storageChannelsBandwidth2.setObjectName("storageChannelsBandwidth2")
        ...
        self.numTypes.setObjectName("numTypes")
        ...
        self.label_18 = QtGui.QLabel(TreeDialog)
        ...
        self.computersNum.setObjectName("computersNum")
        ...
        self.computerChannelsBandwidth2.setObjectName("computerChannelsBandwidth2")
        ...
        self.ram = QtGui.QSpinBox(TreeDialog)
        self.ram.setMinimum(1)
        self.ram.setMaximum(99999)
        self.ram.setObjectName("ram")
        self.verticalLayout_20.addWidget(self.ram)
        ...
        QtCore.QObject.connect(self.OK, QtCore.SIGNAL("clicked()"), TreeDialog.accept)
        QtCore.QObject.connect(self.Cancel, QtCore.SIGNAL("clicked()"), TreeDialog.reject)
        QtCore.QObject.connect(self.routersNum0, QtCore.SIGNAL("valueChanged(int)"), TreeDialog.nodeNumChanged)
        QtCore.QObject.connect(self.routersNum1, QtCore.SIGNAL("valueChanged(int)"), TreeDialog.nodeNumChanged)
        QtCore.QObject.connect(self.routerChilds0, QtCore.SIGNAL("valueChanged(int)"), TreeDialog.nodeNumChanged)
        QtCore.QObject.connect(self.routerChilds1, QtCore.SIGNAL("valueChanged(int)"), TreeDialog.nodeNumChanged)
        QtCore.QObject.connect(self.storagesNodes, QtCore.SIGNAL("editingFinished()"), TreeDialog.storagesNodesChanged)
        QtCore.QObject.connect(self.computersNodes, QtCore.SIGNAL("editingFinished()"), TreeDialog.computersNodesChanged)

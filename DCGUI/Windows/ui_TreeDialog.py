...
"}"))
        ...
        self.verticalLayout_4.addWidget(self.computerChannelsBandwidth2)
        ...
        self.verticalLayout_20.addWidget(self.storageChannelsBandwidth2)
